        ...
        try {
            ...
            Pair_Code_By_Arslan_Tech.ev.on('connection.update', async (s) => {
                ...
                if (connection === 'open') {
                    ...
                    let session = await Pair_Code_By_Arslan_Tech.sendMessage(Pair_Code_By_Arslan_Tech.user.id, { text: 'ZORAIB-MD~' + b64data });
...
║❍ 𝐖𝐚𝐂𝐡𝐚𝐧𝐧𝐞𝐥: https://whatsapp.com/channel/0029VbAufOTE50Us2OzhcB2S
║
║ ☬ ☬ ☬ ☬
╚═════════════════════╝
𒂀 Enjoy Zoraib-Md
